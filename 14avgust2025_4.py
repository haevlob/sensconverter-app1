...
class SensitivityConverter(BoxLayout):
    ...
    def create_widgets(self):
        ...
        left_title = Label(text="Исходная игра", size_hint_y=None, height=dp(30), halign='center', valign='middle')
        ...
        right_title = Label(text="Целевая игра", size_hint_y=None, height=dp(30), halign='center', valign='middle')
        ...
        for standoff_label, pubg_label, cod_label, key in rows:
            ...
            if add_left:
                ...
                if left_game == "standoff":
                    ...
                    if mode == "auto" and key == "general_3p" and left_label_text == "3 лицо.":
                        state = False
                    elif mode == "manual" and key in ["general_3p", "general_1p", "col", "2x", "3x", "4x", "6x", "8x", "6x_sniper"] and left_label_text:
                        state = False
    ...
    def update_auto_conversion(self, key, right_input, left_input, value, *args):
        ...
        if left_game == "pubg" and right_game == "cod" and key == "general_3p":
            ...
            if key == "general_3p":
                ...
                for _, ri, k, _, _ in self.entry_widgets:
                    if k in ["general_3p", "general_1p", "col", "2x", "3x", "4x", "6x", "8x"]:
